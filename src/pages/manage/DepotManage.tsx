...
const pageSize = 5;
export function DepotManage():JSX.Element{
    useDocumentTitle('商场进存销管理系统——库存信息')
    ...
    const columns = [
        ...
        <Button type="link"><Link to={`/depot/edit/${record.id}`}>编辑</Link></Button>
  ...
  >
     ...
     <Button type="primary" className="add"><Link to="/depot/add">新增</Link></Button>
     <Table
