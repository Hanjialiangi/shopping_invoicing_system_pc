...
export function DepotManageEdit():JSX.Element{
    useDocumentTitle('商场进存销管理系统——修改库存信息');
   ...
   const Init =()=>{
    ...
    if(param.id){
        data = depotInfo[Number(param.id)-1]
    }
  ...
  useEffect(()=>{
    ...
    return <>
    <div className="formtitle"><a href="/depot/manage">库存信息</a>/修改库存信息</div>
